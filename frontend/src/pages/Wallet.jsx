...
const Header = styled.div`display:flex;align-items:center;gap:12px;padding:20px 20px 0;`;
...
const Bento = styled.div`padding:16px 20px;display:grid;grid-template-columns:1fr 1fr;gap:12px;`;
const BalanceTile = styled.div`grid-column:span 2;background:${p=>p.theme.primary};border:${p=>p.theme.border};border-radius:${p=>p.theme.radius};padding:24px;box-shadow:${p=>p.theme.shadowLg};color:#fff;`;
const BalTop = styled.div`display:flex;align-items:center;gap:12px;margin-bottom:4px;`;
const BalIcon = styled.div`opacity:0.8;`;
const BalVal = styled.div`font-family:'Syne',sans-serif;font-size:48px;font-weight:800;line-height:1;`;
const BalLabel = styled.div`font-size:11px;font-weight:700;letter-spacing:1.5px;opacity:0.7;margin-bottom:14px;`;
...
const EarnedTile = styled.div`background:#d1fae5;border:${p=>p.theme.border};border-radius:${p=>p.theme.radius};padding:18px;box-shadow:${p=>p.theme.shadow};`;
const SpentTile = styled.div`background:#fecaca;border:${p=>p.theme.border};border-radius:${p=>p.theme.radius};padding:18px;box-shadow:${p=>p.theme.shadow};`;
const MiniLabel = styled.div`font-size:10px;font-weight:700;letter-spacing:1.5px;color:#1a1a1a;margin-bottom:6px;`;
const MiniVal = styled.div`font-family:'Syne',sans-serif;font-size:28px;font-weight:800;color:${p=>p.$green?"#065f46":"#991b1b"};`;
const MiniSub = styled.div`font-size:11px;color:#1a1a1a;margin-top:2px;`;
const HistoryTile = styled.div`grid-column:span 2;background:${p=>p.theme.card};border:${p=>p.theme.border};border-radius:${p=>p.theme.radius};padding:16px;box-shadow:${p=>p.theme.shadow};display:flex;flex-direction:column;gap:8px;`;
...
const TxRow = styled.div`display:flex;align-items:center;gap:10px;background:${p=>p.theme.surface};border:${p=>p.theme.border};border-radius:${p=>p.theme.radius};padding:11px 12px;`;
const TxIco = styled.div`width:34px;height:34px;border-radius:${p=>p.theme.radius};background:${p=>p.$green?"#d1fae5":"#fecaca"};border:${p=>p.theme.border};display:flex;align-items:center;justify-content:center;color:${p=>p.$green?"#065f46":"#991b1b"};flex-shrink:0;`;
const TxInfo = styled.div`flex:1;`;
const TxLabel = styled.div`font-size:13px;font-weight:600;color:#1a1a1a;`;
const TxDate = styled.div`font-size:11px;color:${p=>p.theme.muted};margin-top:1px;`;
const TxAmt = styled.div`font-size:13px;font-weight:700;color:${p=>p.$green?"#065f46":"#991b1b"};`;
